        ...
        <div class="main-content">
            ...
            <div class="content-container">
                ...
                <div class="form-container">
                    ...
                    <form class="pharmacist-form" action="<?php echo ROOT; ?>/Admin/pharmacistForm1" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" id="emergency_contact" name="emergency_contact_no" class="emergency-input" value="<?= htmlspecialchars($formData['emergency_contact_no'] ?? '') ?>" required>
                        </div>
