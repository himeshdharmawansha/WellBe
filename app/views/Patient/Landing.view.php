...
<head>
  ...
  <link rel="stylesheet" href="<?= ROOT ?>/assets/css/Patient/landing.css?v=<?= time() ?>" />
  <title>Well Be</title>
</head>
...
<body>
  <header>
    <nav class="section__container nav__container">
      <div class="nav__logo"><img src="./assets/logo.png" />WELL BE</div>
      ...
      <ul class="nav__links">
        ...
        <li class="link dropdown">
          ...
          <div class="dropdown-content" id="dropdownMenu">
            <p>Login as</p>
            <form method="post">
              <a href="./Login.php" data-type="doctor" class="loginFilter">Doctor</a>
              <a href="./Login.php" data-type="patient" class="loginFilter">Patient</a>
            </form>
          </div>
        </li>

        <script>
        document.querySelectorAll('.loginFilter').forEach(link => {
            link.addEventListener('click', function (e) {
                e.preventDefault();
                const userType = this.getAttribute('data-type');
                // Dynamically set the value of the hidden input before submitting the form
    ...
    <div class="section__container header__container" id="home">
      <div class="header__content">
        ...
        <button class="btn" onclick="window.location.href='./Login.php'">Book Appointment</button>
      </div>
  ...
  <footer class="footer">
    <div class="section__container footer__container">
      <div class="footer__col">
        <div class="footer__logo"><img src="./assets/logo.png" /></div>
        <p>
